...
HD_PWD='C:/Users/tekpun/Desktop/Microblazedigitalstopwatch/microblazedigital/microblazedigital.runs/mbdesign_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_rst_clk_wiz_1_100M_0.tcl
