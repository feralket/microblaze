...
HD_PWD='C:/Users/tekpun/Desktop/Microblazedigitalstopwatch/microblazedigital/microblazedigital.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_wrapper.tcl
