...
HD_PWD='C:/Users/tekpun/Desktop/Microblazedigitalstopwatch/microblazedigital/microblazedigital.runs/mbdesign_axi_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_axi_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_axi_timer_0_1.tcl
