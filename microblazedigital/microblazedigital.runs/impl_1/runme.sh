...
HD_PWD='C:/Users/tekpun/Desktop/Microblazedigitalstopwatch/microblazedigital/microblazedigital.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mbdesign_wrapper.tcl -notrace
